...
# Based on this asm by UnclePunch:
# https://github.com/project-slippi/slippi-ssbm-asm/blob/green-when-actionable/External/GreenDuringWait/fall.asm

.include "Common/Common.s"
.include "Online/Online.s"

.set REG_FighterData,31
.set SFX_PlaySound, 0x801c53ec # r3=soundid
